    ...
    inlinescript {
        ...
        try {
            ...
            if (Test-Path "$SourceFilesParentDir\SystemCenter\ConfigMgr2012R2wSP1\SMSSETUP\BIN\X64\Configmgr2012R2SP1.msi") {
                ...
                # Call Configmgr2012R2SP1.msi with arguments for unattended installation
                ...
                Throw "Unable to locate Configmgr2012R2SP1.msi"
            }
        }
        catch {
            Write-Verbose "Failed to install CM 2012 R2 with SP1"
            Write-Error $_.Exception
			Throw "Failed to install CM 2012 R2 with SP1"
        }
