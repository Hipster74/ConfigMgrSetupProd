...
SQLBACKUPDIR="g:\DBBackup\MSSQL12.A149999\MSSQL\Backup"

; Default directory for the Database Engine user databases. 
SQLUSERDBDIR="d:\MSSQL12.A$CustomerNumber\MSSQL\Data"

; Default directory for the Database Engine user database logs. 
SQLUSERDBLOGDIR="e:\MSSQL12.A$CustomerNumber\MSSQL\Data"

; Directory for Database Engine TempDB files. 
SQLTEMPDBDIR="f:\MSSQL12.A$CustomerNumber\MSSQL\Data"

; Directory for the Database Engine TempDB log files. 
SQLTEMPDBLOGDIR="f:\MSSQL12.A$CustomerNumber\MSSQL\Data"
