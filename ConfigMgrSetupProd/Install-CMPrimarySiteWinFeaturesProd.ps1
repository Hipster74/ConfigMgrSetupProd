Workflow Install-CMPrimarySiteWinFeaturesProd {
    Param (
    ...
    inlinescript {
        ...
        if ($MacSupport) {
            Write-Verbose "Features required for installing Macsupport in CM requested"
